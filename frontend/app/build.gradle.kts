...
android {
    ...
    productFlavors {
        create("dev") {
            ...
            // Base URL includes the API prefix as it's an infrastructure concern
...
dependencies {
    ...
    kover(project(":feature:seasonslist"))
    kover(project(":feature:racewinners"))
}
        ...
        filters {
            excludes {
                ...
                packages(
                    "com.f1champions.app",
                    "com.f1champions.**.di",
                    "com.f1champions.**.**.navigation",
                    "com.f1champions.**.**.ui.screen",
                    "dagger.hilt.**",
                    "hilt**"
                )
            }
